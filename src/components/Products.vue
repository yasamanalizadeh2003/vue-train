...
const items = [
  {
    ...
    category: 'SEATING',
    price: '€680',
    caption: 'Canvas & steel, reduced to what matters.',
  },

  {
    ...
    category: 'CERAMICS',
    price: '€195',
    caption: 'Three forms, one conversation.',
  },
  {
    id:3,
    name: 'Shelf System',
  ...
  },
  {
    ...
    category: 'STORAGE',
    price: '€1,240',
    caption: 'A shelf that thinks in columns.',
  },
]
...
<template>
  ...
  <div class="font-serif text-2xl sm:text-3xl lg:text-4xl px-10 pt-8">The collection</div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 p-4 sm:p-6 md:p-10">
    <div
      ...
      :key="item.name"
      class="group bg-white border border-gray-100 rounded-2xl p-4 sm:p-5 cursor-pointer shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
    >
      <!-- Category -->
      ...
      <!-- Name -->
      <div
        class="text-base sm:text-lg font-semibold text-gray-800 group-hover:text-black transition"
      >
        {{ item.name }}
      </div>
